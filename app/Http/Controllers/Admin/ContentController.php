...
class ContentController extends Controller
{
    ...
    public function update(Request $request)
    {
        $tenant = auth()->user()->tenant;
        $rules = [
            'contact_phone' => ['nullable', 'string', 'max:30'], 'logo' => ['nullable', 'image', 'max:2048'], 'hero_image' => ['nullable', 'image', 'max:6144'],
        ...
        unset($data['contact_phone'], $data['logo'], $data['hero_image']);
    ...
    public static function defaults(): array
    {
        return [
            ...
            'show_faq' => true, 'faq_eyebrow' => 'ANTES DE PEDIR', 'faq_title' => 'Dúvidas rápidas.', 'faq_1_question' => 'Como identifico o produto correto?', 'faq_1_answer' => 'Informe o nome e o código exibidos na página do produto.', 'faq_2_question' => 'Os valores estão atualizados?', 'faq_2_answer' => 'Os valores do catálogo são mantidos pela equipe responsável.', 'faq_3_question' => 'Como faço meu pedido?', 'faq_3_answer' => 'Use o botão de contato e envie os dados do produto escolhido.', 'footer_text' => 'Produtos apresentados com clareza e atendimento próximo.',
        ];
    }
}
